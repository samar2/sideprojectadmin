          ...
          <Collapse in={this.state.tableMenuOpen}>
            <div>
              <ul className="nav">
                ...
                <li
                  className={
                    this.isPathActive("/tables/extended-tables-messages")
                      ? "active"
                      : null
                  }
                >
                  <Link to="/tables/extended-tables-messages">
                    Messages Table
                  </Link>
                </li>
                <li
                  className={
                    this.isPathActive("/tables/extended-tables-categories")
                      ? "active"
                      : null
                  }
                >
                  <Link to="/tables/extended-tables-categories">
                    Categories Table
                  </Link>
                </li>
                <li
                  className={
                    this.isPathActive("/tables/extended-tables-items")
                      ? "active"
                      : null
                  }
                >
                  <Link to="/tables/extended-tables-items">Items Table</Link>
                </li>
